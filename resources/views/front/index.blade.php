...
<body class="font-[Poppins] pb-[72px]">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <p
                                ...
                                {{ $article->category?->name }}</p>
                            <img src="{{ asset('storage/' . $article->thumbnail) }}" class="object-cover w-full h-full"
                                alt="thumbnail" />
                        </div>
    ...
    <section id="Latest-entertainment" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
        ...
        <div class="flex justify-between items-center h-fit">
            @if ($entertainment_featured_article)
                <div class="featured-news-card relative w-full h-[424px] flex flex-1 rounded-[20px] overflow-hidden">
                    <img src="{{ asset('storage/' . $entertainment_featured_article->thumbnail) }}"
                        class="thumbnail absolute w-full h-full object-cover" alt="icon" />
                    <div
                    ...
                    <div class="card-detail w-full flex items-end p-[30px] relative z-20">
                        <div class="flex flex-col gap-[10px]">
                            <p class="text-white">Featured</p>
                            <a href="{{ route('front.details', $entertainment_featured_article->slug) }}"
                                class="font-bold text-[30px] leading-[36px] text-white hover:underline transition-all duration-300">{{ str()->limit($entertainment_featured_article->name, 50) }}</a>
                            <p class="text-white">{{ $entertainment_featured_article->created_at->format('d M, Y') }}
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section id="Latest-business" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
        ...
        <div class="flex justify-between items-center h-fit">
            @if ($business_featured_article)
                <div class="featured-news-card relative w-full h-[424px] flex flex-1 rounded-[20px] overflow-hidden">
                    <img src="{{ asset('storage/' . $business_featured_article->thumbnail) }}"
                        class="thumbnail absolute w-full h-full object-cover" alt="icon" />
                    <div
                        class="w-full h-full bg-gradient-to-b from-[rgba(0,0,0,0)] to-[rgba(0,0,0,0.9)] absolute z-10">
                    </div>
                    <div class="card-detail w-full flex items-end p-[30px] relative z-20">
                        <div class="flex flex-col gap-[10px]">
                            <p class="text-white">Featured</p>
                            <a href="{{ route('front.details', $business_featured_article->slug) }}"
                                class="font-bold text-[30px] leading-[36px] text-white hover:underline transition-all duration-300">{{ str()->limit($business_featured_article->name, 50) }}</a>
                            <p class="text-white">{{ $business_featured_article->created_at->format('d M, Y') }}
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section id="Latest-automotive" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
        ...
        <div class="flex justify-between items-center h-fit">
            @if ($automotive_featured_article)
                <div class="featured-news-card relative w-full h-[424px] flex flex-1 rounded-[20px] overflow-hidden">
                    <img src="{{ asset('storage/' . $automotive_featured_article->thumbnail) }}"
                        class="thumbnail absolute w-full h-full object-cover" alt="icon" />
                    <div
                        class="w-full h-full bg-gradient-to-b from-[rgba(0,0,0,0)] to-[rgba(0,0,0,0.9)] absolute z-10">
                    </div>
                    <div class="card-detail w-full flex items-end p-[30px] relative z-20">
                        <div class="flex flex-col gap-[10px]">
                            <p class="text-white">Featured</p>
                            <a href="{{ route('front.details', $automotive_featured_article->slug) }}"
                                class="font-bold text-[30px] leading-[36px] text-white hover:underline transition-all duration-300">{{ str()->limit($automotive_featured_article->name, 50) }}</a>
                            <p class="text-white">{{ $automotive_featured_article->created_at->format('d M, Y') }}
                            </p>
                        </div>
                    </div>
                </div>
